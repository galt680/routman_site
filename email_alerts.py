...
def send_alert(db_name = None, table_name = None, watchlist_name = None,  test = False):
...
send_alert(db_name = "ALERT_DATA",table_name = 'ALERT_DATA',watchlist_name= "your watchlist")       
